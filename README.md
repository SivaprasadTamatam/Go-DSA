...
Before running the solutions, ensure you have the following setups:

1. [Go/Golang installation setup](https://golang.org/doc/install)
2. [Visual Studio Code installation setup](https://code.visualstudio.com/download)
...
7. [Find the Minimum in Rotated Sorted Array](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/)
...
23. [Encode and Decode Strings](https://leetcode.com/problems/encode-and-decode-strings/)
...
28. [Remove Nth Node From End of List](https://leetcode.com/problems/remove-nth-node-from-end-of-list/)
29. [Reorder List](https://leetcode.com/problems/reorder-list/)
...
33. [Binary Tree Maximum Path Sum](https://leetcode.com/problems/binary-tree-maximum-path-sum/)
34. [Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/)
35. [Serialize & Deserialize Binary Tree](https://leetcode.com/problems/serialize-and-deserialize-binary-tree/)
36. [Design Add and Search Words Data Structure](https://leetcode.com/problems/design-add-and-search-words-data-structure/)
...
39. [Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/)
...
46. [Coin Change](https://leetcode.com/problems/coin-change/)

### Bitwise Operator

47. [Sum of Two Integers](https://leetcode.com/problems/sum-of-two-integers/)
48. [Number of 1 Bit](https://leetcode.com/problems/number-of-1-bits/)
49. [Counting Bits](https://leetcode.com/problems/counting-bits/)
50. [Missing Number](https://leetcode.com/problems/missing-number/)
